...
namespace MBS.Lightfall
{
    ...
    /// </summary>
    [CustomEditor(typeof(LightfallHealth))]
    public class LightfallHealthInspector : StateBehaviorInspector
    {
        ...
        private LightfallHealth m_Health;
        ...
        protected override void OnEnable()
        {
            ...
            m_Health = target as LightfallHealth;
        ...
        protected override Action GetDrawCallback()
        {
            ...
            baseCallback += () =>
            {
                ...
                {
                    EditorGUI.indentLevel++;
                    if (Opsive.Shared.Editor.Inspectors.Utility.InspectorUtility.Foldout(target, "Take Damage"))
                    {
                        EditorGUI.indentLevel++;
                    ...
                    if (Opsive.Shared.Editor.Inspectors.Utility.InspectorUtility.Foldout(target, "Heal"))
                    {
                        EditorGUI.indentLevel++;
                    ...
                    if (Opsive.Shared.Editor.Inspectors.Utility.InspectorUtility.Foldout(target, "Death"))
                    {
                        EditorGUI.indentLevel++;
                ...
                {
                    EditorGUI.indentLevel++;
                    Opsive.Shared.Editor.Inspectors.Utility.InspectorUtility.UnityEventPropertyField(PropertyFromName("m_OnDamageEvent"));
                    Opsive.Shared.Editor.Inspectors.Utility.InspectorUtility.UnityEventPropertyField(PropertyFromName("m_OnHealEvent"));
                    Opsive.Shared.Editor.Inspectors.Utility.InspectorUtility.UnityEventPropertyField(PropertyFromName("m_OnDeathEvent"));
                    EditorGUI.indentLevel--;
                }
            };
        ...
        static void DrawHitboxGizmo(LightfallHealth health, GizmoType gizmoType)
        {
