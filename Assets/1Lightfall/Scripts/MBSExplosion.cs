...
{
    public class MBSExplosion : MonoBehaviour, IDamageSource
    {
        ...
        [SerializeField]
        protected MBSImpactDamageDataForInspector m_ImpactDamageDataForInspector = new MBSImpactDamageDataForInspector()
        {
            DamageAmount = 10,
            ImpactForce = 2,
            ImpactForceFrames = 1,
        ...
        protected MBS.DamageSystem.ImpactDamageData m_ImpactDamageData;
        ...
        public MBS.DamageSystem.ImpactDamageData ImpactDamageData { get { return m_ImpactDamageData; } set { m_ImpactDamageData = value; } }
        ...
        private MBS.DamageSystem.ImpactDamageData m_CachedDamageData;
        ...
        //Inital values, used to reset the component due to cacheing and reuse.
        protected bool m_InitalExplodeOnEnable;
        protected float m_InitalRadius;
        protected MBSImpactDamageDataForInspector m_InitalImpactDamageDataForInspector;
        protected MBS.DamageSystem.ImpactDamageData m_InitalImpactDamageData;
        protected bool m_InitalLineOfSight;
        protected float m_InitalLifespan;
        protected int m_InitalMaxCollisionCount;
        protected AudioClipSet m_InitalExplosionAudioClipSet = new AudioClipSet();
        private HashSet<object> m_InitalObjectExplosions;
        private Collider[] m_InitalCollidersHit;
        ...
        private void Awake()
        {
            ...
            ImpactDamageData = new MBS.DamageSystem.ImpactDamageData().InjectValues(m_ImpactDamageDataForInspector);
            m_CachedDamageData = new MBS.DamageSystem.ImpactDamageData();
            m_CachedImpactCollisionData = new ImpactCollisionData();
            m_CachedImpactCallbackContext = new ImpactCallbackContext();

            //inital values
            m_InitalExplodeOnEnable = m_ExplodeOnEnable;
            m_InitalRadius = m_Radius;
            m_InitalImpactDamageDataForInspector = m_ImpactDamageDataForInspector;
            m_InitalImpactDamageData = new MBS.DamageSystem.ImpactDamageData().InjectValues(m_ImpactDamageDataForInspector);
            m_InitalLineOfSight = m_LineOfSight;
            m_InitalLifespan = m_Lifespan;
            m_InitalMaxCollisionCount = m_MaxCollisionCount;
            m_InitalExplosionAudioClipSet = m_ExplosionAudioClipSet;
            m_InitalObjectExplosions = m_ObjectExplosions;
            m_InitalCollidersHit = m_CollidersHit;

        }

        public void ResetExplosionValues()
        {
            m_ExplodeOnEnable = m_InitalExplodeOnEnable;
            m_Radius = m_InitalRadius;
            m_ImpactDamageDataForInspector = m_InitalImpactDamageDataForInspector.Copy();
            ImpactDamageData = new MBS.DamageSystem.ImpactDamageData().InjectValues(m_ImpactDamageDataForInspector);
            m_LineOfSight = m_InitalLineOfSight;
            m_Lifespan = m_InitalLifespan;
            m_MaxCollisionCount = m_InitalMaxCollisionCount;
            m_ExplosionAudioClipSet = m_InitalExplosionAudioClipSet;
            m_ObjectExplosions = m_InitalObjectExplosions;
            m_CollidersHit = m_InitalCollidersHit;
        }
        ...
        {
            var impactData = new ImpactCollisionData();//m_CachedImpactCollisionData;
            impactData.Reset();
        ...
        private void OnValidate()
        {
            ...
            if (ImpactDamageData != null)
                ImpactDamageData.InjectValues(m_ImpactDamageDataForInspector);
        }
    }
}
