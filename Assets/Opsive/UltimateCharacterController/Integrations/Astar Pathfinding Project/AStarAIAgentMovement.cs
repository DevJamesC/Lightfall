...
namespace Opsive.UltimateCharacterController.Integrations.AstarPathfindingProject
{
    ...
    public class AStarAIAgentMovement : PathfindingMovement
    {
        ...
        public override void Awake()
        {
            ...
            var richAI = m_GameObject.GetComponent<RichAI>();
            if (richAI != null) {
        ...
        {
            var position = m_Rigidbody.position + m_CharacterLocomotion.DesiredMovement;
            var rotation = m_Rigidbody.rotation * m_CharacterLocomotion.DesiredRotation;
            m_IAstarAIAgent.FinalizeMovement(position, rotation);
        }
